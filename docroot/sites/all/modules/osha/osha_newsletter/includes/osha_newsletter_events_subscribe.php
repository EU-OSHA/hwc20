 ...
 */
function osha_newsletter_events_subscribe_form() {
  $form['intro'] = array(
    '#markup' => t(variable_get('events_subscribe_block_intro_text', 'Once a month, OSHmail keeps you updated on ocupational safety and health.<br/> You can sign up below:')),
  );
  ...
  $form['subscribe_details']['submit'] = array(
    '#type' => 'submit',
    '#value' => t('Subscribe'),
    '#submit' => array('osha_newsletter_events_subscribe_form_submit'),
  );

  $link_label = t(variable_get('events_subscribe_block_details_link_label', 'How will EU-OSHA use my details?'));
  ...
  $form['#validate'] = array('osha_newsletter_events_subscribe_form_validate');
 ...
 */
function osha_newsletter_events_subscribe_form_validate($form, &$form_state) {
 ...
 */
function osha_newsletter_events_subscribe_form_submit($form, &$form_state) {
